...
export function FeaturedCars({ initialCars }: FeaturedCarsProps) {
  ...
  return (
    <section id="estoque" className="relative bg-card py-16 md:py-24">
      <div className="mx-auto max-w-7xl px-5">
        <div className="mb-10 flex flex-col items-start justify-between gap-4 md:flex-row md:items-end">
          ...
          <Link
            to="/estoque"
            className="inline-flex items-center gap-2 rounded-full border border-border bg-background px-5 py-3 text-xs font-bold uppercase tracking-wider text-foreground transition hover:border-primary hover:text-primary"
          >
        ...
        <div className="-mx-5 overflow-x-auto snap-x snap-mandatory pb-4 scrollbar-hide sm:mx-0 sm:overflow-visible sm:snap-none sm:pb-0">
          <div className="flex gap-5 px-5 sm:grid sm:grid-cols-2 sm:px-0 lg:grid-cols-4">
            {cars.map((car, index) => {
