...
import { Eye, MessageCircle, TrendingUp, Users, Trophy, Flame, Car as CarIcon } from "lucide-react";
import {
  Area,
  AreaChart,
  CartesianGrid,
        ...
        <div className="h-64 w-full">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={activity} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
              ...
              />
              <Area type="monotone" dataKey="views" name="Visualizações" stroke="oklch(0.62 0.24 25)" strokeWidth={2.5} fill="url(#gradViews)" />
